...
\begin{figure}[t]
\centering
\fbox{\rule{0pt}{1.35in}\rule{0.9\columnwidth}{0pt}}
\caption{Placeholder for a properly cropped figure. Replace this box with a real PDF, PNG, or JPEG rather than relying on trim or clip commands in LaTeX.}
\label{fig1}
\end{figure}

\begin{figure*}[t]
\centering
\fbox{\rule{0pt}{1.8in}\rule{0.8\textwidth}{0pt}}
\caption{Placeholder for a two-column figure. Replace this box with a real, externally cropped figure asset before submission.}
\label{fig2}
\end{figure*}
