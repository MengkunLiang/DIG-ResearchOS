#!/usr/bin/env python3
"""Validate schema, lineage, and decision-boundary requirements for the module attribution Skill.

The ``validate attribution report`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
