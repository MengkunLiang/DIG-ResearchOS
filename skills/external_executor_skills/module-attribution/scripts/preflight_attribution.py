#!/usr/bin/env python3
"""Validate prerequisites before the executor phase can mutate artifacts for the module attribution Skill.

The ``preflight attribution`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
