#!/usr/bin/env python3
"""Compute a deterministic metric or gate from validated evidence for the module attribution Skill.

The ``compute attribution gate`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
