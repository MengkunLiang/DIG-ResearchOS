#!/usr/bin/env python3
"""Build a deterministic phase artifact from declared inputs for the module attribution Skill.

The ``build attribution snapshot`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
