#!/usr/bin/env python3
"""Inventory declared artifacts and preserve their provenance for the module attribution Skill.

The ``inventory modules`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
