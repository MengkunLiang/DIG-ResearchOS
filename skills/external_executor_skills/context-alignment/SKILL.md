...
Treat preflight warnings as prompts for evidence review, not automatic blockers. Missing `resources/baseline_candidates.jsonl`, missing `literature/baseline_map.json`, or an empty `novelty/required_baselines.json` is not a Phase A blocker.
