#!/usr/bin/env python3
"""Perform deterministic static inspection of declared resources for the resource and baseline preparation Skill.

The ``static review repository`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
