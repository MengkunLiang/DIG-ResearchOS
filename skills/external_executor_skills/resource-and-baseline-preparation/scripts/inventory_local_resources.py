#!/usr/bin/env python3
"""Inventory declared artifacts and preserve their provenance for the resource and baseline preparation Skill.

The ``inventory local resources`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
