#!/usr/bin/env python3
"""Stage a declared resource under the phase access policy for the resource and baseline preparation Skill.

The ``stage local resource`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
