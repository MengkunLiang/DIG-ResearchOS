#!/usr/bin/env python3
"""Compare declared artifacts while retaining lineage and uncertainty for the result diagnosis Skill.

The ``compare methods`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
