#!/usr/bin/env python3
"""Atomically apply a validated phase report to its owned result-pack section for the result diagnosis Skill.

The ``apply diagnosis report`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
