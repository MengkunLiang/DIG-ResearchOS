#!/usr/bin/env python3
"""Initialize the durable report envelope for one executor phase for the result diagnosis Skill.

The ``initialize diagnosis report`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
