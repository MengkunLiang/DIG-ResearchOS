...
def main() -> int:
    ...
    parser.add_argument("--plan-validation", default="external_executor/experiment_plan_validation.json")
    parser.add_argument("--dag-validation", default="external_executor/experiment_plan_dag_validation.json")
    parser.add_argument("--output", default="external_executor/experiment_design_gate.json")
