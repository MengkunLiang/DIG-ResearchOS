...
def main() -> int:
    ...
    parser.add_argument("--report", default="external_executor/experiment_design_report.json")
    parser.add_argument("--validation", default="external_executor/experiment_design_report_validation.json")
