#!/usr/bin/env python3
"""Render a declared evidence artifact without inventing research content for the evidence packaging Skill.

The ``render framework figure`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
...
def main() -> int:
    ...
    parser.add_argument("--spec", default="external_executor/report/phase_F/framework_figure_spec.json")
    parser.add_argument("--svg", default="external_executor/figure/framework_figure.svg")
    parser.add_argument("--mermaid", default="external_executor/report/phase_F/framework_figure.mmd")
