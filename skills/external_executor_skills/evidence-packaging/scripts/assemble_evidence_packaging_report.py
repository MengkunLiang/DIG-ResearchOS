#!/usr/bin/env python3
"""Assemble a durable phase report from validated artifacts for the evidence packaging Skill.

The ``assemble evidence packaging report`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
