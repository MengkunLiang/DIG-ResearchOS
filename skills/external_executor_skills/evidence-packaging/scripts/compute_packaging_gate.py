#!/usr/bin/env python3
"""Compute a deterministic metric or gate from validated evidence for the evidence packaging Skill.

The ``compute packaging gate`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
...
def main() -> int:
    ...
    parser.add_argument("--snapshot-validation", default="external_executor/report/phase_F/final_evidence_snapshot_validation.json")
    ...
    parser.add_argument("--mapping", default="external_executor/report/phase_F/evidence_mapping.json")
    parser.add_argument("--manifest", default="external_executor/report/phase_F/evidence_package_manifest.json")
    ...
    parser.add_argument("--output", default="external_executor/report/phase_F/evidence_packaging_gate.json")
