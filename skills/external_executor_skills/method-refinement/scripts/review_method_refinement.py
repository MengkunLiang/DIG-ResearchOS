...
def main() -> int:
    ...
    parser.add_argument("--scope-assessment", default="external_executor/method_scope_assessment.json")
    parser.add_argument("--spec-validation", default="external_executor/method_implementation_spec_validation.json")
    parser.add_argument("--output", default="external_executor/method_refinement_review.json")
