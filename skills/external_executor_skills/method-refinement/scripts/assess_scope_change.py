#!/usr/bin/env python3
"""Perform the declared deterministic executor operation for the method refinement Skill.

The ``assess scope change`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
