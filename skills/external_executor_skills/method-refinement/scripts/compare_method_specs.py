#!/usr/bin/env python3
"""Compare declared artifacts while retaining lineage and uncertainty for the method refinement Skill.

The ``compare method specs`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
