#!/usr/bin/env python3
"""Assemble a durable phase report from validated artifacts for the method refinement Skill.

The ``assemble method refinement report`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
...
def main() -> int:
    ...
    parser.add_argument("--output", default="external_executor/report/phase_D/method_refinement_report.json")
    args = parser.parse_args()
    ws = resolve_workspace(args.workspace)
    ext = ws / "external_executor"

    paths = {
        "preflight": "external_executor/report/phase_D/method_refinement_preflight.json",
        "intent_contract": "external_executor/report/phase_D/method_intent_contract.json",
        "implementation_spec": "external_executor/method_implementation_spec.json",
        "spec_fingerprint": "external_executor/report/phase_D/method_spec_fingerprint.json",
        "delta": "external_executor/report/phase_D/method_delta.json",
        "scope_assessment": "external_executor/report/phase_D/method_scope_assessment.json",
        "spec_validation": "external_executor/report/phase_D/method_implementation_spec_validation.json",
        "review": "external_executor/report/phase_D/method_refinement_review.json",
        "implementation_brief": "external_executor/report/phase_D/method_implementation_brief.md",
    }
