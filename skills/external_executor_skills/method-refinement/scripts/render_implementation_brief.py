#!/usr/bin/env python3
"""Render a declared evidence artifact without inventing research content for the method refinement Skill.

The ``render implementation brief`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
...
def main() -> int:
    ...
    parser.add_argument("--review", default="external_executor/report/phase_D/method_refinement_review.json")
    parser.add_argument("--output", default="external_executor/report/phase_D/method_implementation_brief.md")
