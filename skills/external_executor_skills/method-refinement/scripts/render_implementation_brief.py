...
def main() -> int:
    ...
    parser.add_argument("--review", default="external_executor/report/method_refinement_review.json")
    parser.add_argument("--output", default="external_executor/report/method_implementation_brief.md")
