#!/usr/bin/env python3
"""Evaluate declared evidence against the phase acceptance contract for the baseline reproduction Skill.

The ``evaluate reproduction`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
