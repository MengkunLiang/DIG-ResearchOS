#!/usr/bin/env python3
"""Run the declared bounded operation and preserve its outcome evidence for the baseline reproduction Skill.

The ``run reproduction`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
