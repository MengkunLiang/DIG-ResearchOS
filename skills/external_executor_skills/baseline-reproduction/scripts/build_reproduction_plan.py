#!/usr/bin/env python3
"""Build a deterministic phase artifact from declared inputs for the baseline reproduction Skill.

The ``build reproduction plan`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
