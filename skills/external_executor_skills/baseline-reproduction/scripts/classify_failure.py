#!/usr/bin/env python3
"""Classify a failure using only direct diagnostic evidence for the baseline reproduction Skill.

The ``classify failure`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
