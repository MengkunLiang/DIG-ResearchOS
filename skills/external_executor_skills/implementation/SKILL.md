...
python <skill-dir>/scripts/preflight_implementation.py --workspace <workspace> \
  --output external_executor/report/phase_D/implementation_preflight.json
```
...
python <skill-dir>/scripts/build_change_contract.py --workspace <workspace> \
  --output external_executor/report/phase_D/implementation_change_contract.json
```
...
python <skill-dir>/scripts/prepare_worktree.py --workspace <workspace> \
  --contract external_executor/report/phase_D/implementation_change_contract.json
```
...
python <skill-dir>/scripts/initialize_implementation_report.py --workspace <workspace> \
  --contract external_executor/report/phase_D/implementation_change_contract.json \
  --output external_executor/report/phase_D/implementation_report.json
```
...
python <skill-dir>/scripts/compute_implementation_gate.py \
  --report <workspace>/external_executor/report/phase_D/implementation_report.json --write-back
