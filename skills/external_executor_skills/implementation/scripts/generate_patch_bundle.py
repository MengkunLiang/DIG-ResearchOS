#!/usr/bin/env python3
"""Generate a bounded evidence artifact from validated inputs for the implementation Skill.

The ``generate patch bundle`` entrypoint is deterministic: it reports contract failures explicitly and never fills missing research facts, authorization, or execution evidence by inference.
"""
