...
TASK_IO_CONTRACTS: dict[str, dict[str, object]] = {
    ...
    "T3.5": {
        ...
        "required_inputs": ["project", "deep_read_notes_dir", "comparison_table", "domain_map"],
        "schemas": {},
    },
    "T3.6-GATE-SURVEY": {
        "inputs": {
    ...
    "T3.6-SUPPLEMENT-READ": {
        "inputs": {
            ...
            "survey_plan": "drafts/survey/survey_plan.json",
            "survey_expansion": "drafts/survey/survey_expansion.json",
            "reading_upgrade_queue": "literature/survey_supplement/reading_upgrade_queue.jsonl",
            "related_work_bib": "literature/related_work.bib",
            "deep_read_notes_dir": "literature/deep_read_notes",
            "shallow_read_notes_dir": "literature/shallow_read_notes",
        },
        "outputs": {"reading_upgrade_receipt": "literature/survey_supplement/reading_upgrade_receipt.json"},
        "optional_outputs": ["reading_upgrade_receipt"],
        "required_inputs": ["project", "survey_plan", "survey_expansion", "reading_upgrade_queue"],
        "schemas": {},
    },
    "T3.6-STATE": {
        "inputs": {
        ...
        "outputs": {
            ...
            "section_evidence_plan": "drafts/survey/section_evidence_plan.json",
        },
    ...
    "T3.6-VISUALS": {
        ...
        "required_inputs": ["project", "survey_plan", "survey_state", "deep_read_notes_dir"],
        "schemas": {},
    },
    "T3.6-SEC-BACKGROUND": {
        "inputs": {
    ...
    "T4": {
        ...
        "outputs": {
            ...
            "evolution_state": "ideation/evolution/state.json",
            "portfolio": "ideation/portfolio.json",
    ...
    "T4.5-FORMALIZE": {
        "inputs": {
            ...
            "synthesis": "literature/synthesis.md",
            "comparison_table": "literature/comparison_table.csv",
            "t4_run_config": "ideation/t4_run_config.json",
        },
        "outputs": {
            "research_blueprint": "ideation/research_blueprint.yaml",
            "claim_registry": "ideation/claim_registry.yaml",
        ...
        "required_inputs": ["project", "hypothesis_brief", "novelty_audit", "synthesis"],
        "schemas": {
    ...
    "T4.5-REVIEW": {
        ...
        "outputs": {"orientation_review": "ideation/orientation_review.json"},
    ...
    "T4.5-HUMAN-REVIEW": {
        ...
        "required_inputs": ["project", "hypothesis_brief", "novelty_audit", "selected_candidate"],
        "schemas": {},
    },
    "T5-HANDOFF": {
        "inputs": {
    ...
    "T5-REBOOST-GATE": {
        ...
        "required_inputs": ["project", "orientation_config", "research_blueprint", "claim_registry", "orientation_review", "hypotheses", "exp_plan", "novelty_audit", "synthesis"],
        "schemas": {},
    },
    "T5-SPECIALIZE-EXECUTOR-SKILLS": {
        ...
        "repository_inputs": {
            "project_skill": "skills/project-skill-specialization/**",
            "specialization_mapping": "skills/external_executor_skills/skill_specialization.yaml",
            "project_skill_context_schema": "skills/external_executor_skills/schemas/project_skill_context.schema.json",
            "external_executor_templates": "skills/external_executor_skills/<13-template-skills>/",
        },
        "outputs": {
...
def task_io_contract_source() -> Path:
    """Return the concrete Python source that supplied the active I/O contract."""
