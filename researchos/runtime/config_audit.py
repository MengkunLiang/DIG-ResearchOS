...
def build_config_audit_summary(config_dir: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "configuration_layers": [
            "日常只改 config/user_settings.yaml：llm.* 管模型，budget.* 管预算，runtime.* 管 timeout/retry/budget escalation。",
            ...
            "agent_params.yaml 是 agent capability registry，只保留工具、路径、prompt、schema、behavior 和 mode 说明。",
