...
_PROFILES: dict[str, StageProfile] = {
    ...
    "T5-RESOURCE-PREP-WAIT": StageProfile("T5 · 准备实验材料", "等待数据、代码、基线和评测工具的准备结果", "实验所需的材料是否已经可以使用？", ("查找公开资源", "检查版本和许可证", "整理材料结果")),
    "T5-PROTOCOL-GATE": StageProfile("T5 · 开始准备实验材料", "确认怎样准备数据、代码、基线和评测工具", "下一步怎样获得实验所需材料？", ("展示实验方案", "选择材料准备方式", "记录准备结果")),
