...
_PROFILES: dict[str, StageProfile] = {
    ...
    "T4.5": StageProfile("T4.5 · 研究方案审计与完善", "比较相似工作并完善所选方向，形成可执行的研究方案", "该方向能否清楚区别于已有工作，并明确研究问题、方法、假设和实验方案？", ("比较相似工作", "明确方法与必要对照", "写出可检验假设和实验方案", "检查方案完整性"), "本阶段依次完成相似工作比较、研究方案撰写和质量审阅；全部通过后进入 T5。"),
    "T4.5-FORMALIZE": StageProfile("T4.5 · 撰写研究方案", "把通过审计的研究方向写成完整、可检验的研究方案", "这个方向能否形成清楚的研究问题、技术方法、可检验假设和实验方案？", ("明确研究问题与方法", "写出可检验假设", "制定实验方案", "完成研究 Proposal")),
    "T4.5-REVIEW": StageProfile("T4.5 · 方案质量审阅", "按选定的写作方向复核并完善研究方案", "技术贡献、设计理由、评测方案和现实意义是否一致、完整？", ("检查研究论证", "检查假设与实验的对应关系", "定向完善", "记录审阅结论")),
