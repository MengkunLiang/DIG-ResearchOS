...
def _section_cdr_responsibility(section_id: str) -> str:
    return {
        ...
        "limitations": "State boundary_conditions and unsupported or skipped evidence honestly.",
        "conclusion": "Return to contribution_type and transferable design knowledge without introducing new evidence.",
