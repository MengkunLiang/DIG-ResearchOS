...
NOTE_CARD_BUDGETS: dict[str, dict[str, int]] = {
    ...
    "introduction": {"initial": 8, "minimum_claim_usable": 5, "maximum": 12},
    "related_work": {"initial": 10, "minimum_claim_usable": 6, "maximum": 14},
    "methodology": {"initial": 6, "minimum_claim_usable": 4, "maximum": 10},
    "experiments": {"initial": 5, "minimum_claim_usable": 3, "maximum": 8},
    "analysis": {"initial": 8, "minimum_claim_usable": 5, "maximum": 12},
    "conclusion": {"initial": 4, "minimum_claim_usable": 3, "maximum": 6},
}
...
def build_section_evidence_supplement(
    ...
    *,
    ...
    if include_weak_cards and len(claim_usable) < min_cards:
