...
def _write_external_executor_guides(
    ...
    *,
    ...
    dir_guide = (
        ...
        "| `skills/` | Project-specific external executor Skill Suite published by the schema-validated T5 reboost compiler. The optional `researchos specialize-executor-skills` command can add LLM guidance later. |\n"
...
class BuildExperimentHandoffPackParams(BaseModel):
    ...
    specialize_skills: bool = Field(
        ...
        description=(
            ...
            "The legacy handoff path uses this option directly; T5-REBOOST publishes its "
            "Skill Suite through compile_research_reboost_handoff."
        ),
    )
...
class CompileResearchReboostHandoffTool(Tool):
    ...
    description = (
        ...
        "external_executor/handoff_pack.json, T5 handoff control files, and the "
        "schema-validated project-specific external executor skill suite."
    )
