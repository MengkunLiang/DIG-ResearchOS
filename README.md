...
| Intentionally restart at T2/T3/T4 | `resume --from-task T4` | Checks the selected stage's prerequisites before safe re-entry; T2/T3 first reopen their research-scope decision, while T4 archives the current Gate1 selection and returns to the existing Candidate Portfolio for a new choice. |
