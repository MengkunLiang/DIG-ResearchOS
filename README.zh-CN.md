...
| `deploy/` | 面向用户的 Docker Compose 部署目录、Docker 环境变量示例和启动脚本；项目数据仍放在顶层 `workspace/` |
...
| `workspace/` | 默认生成的本地 workspace 根目录，不应提交 |
...
宿主机文件位于 `workspace/local-test2`。完整说明见 [deploy/README.md](./deploy/README.md) 和 [docs/docker.md](./docs/docker.md)。
