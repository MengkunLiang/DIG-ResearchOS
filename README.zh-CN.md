...
- 多阶段断点恢复
- artifact 校验
- T4 假设生成会同时落盘 `ideation/idea_rationales.json`，记录每个 idea / hypothesis 的生成依据
...
例如 T4 不只产出 `ideation/hypotheses.md`、`ideation/exp_plan.yaml` 和 `ideation/risks.md`，还会产出 `ideation/idea_rationales.json`，用于追踪每个 idea 对应的文献观察、研究缺口、seed idea、lens insight 与推导逻辑。
