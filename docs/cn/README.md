...
4. T4 在 Evidence-Routed `P0 -> P1` 工作流中使用模型编写的 Candidate 框架、机制，以及一至四条真正独立的 Draft Hypotheses 和 Contribution。运行时代码强制 Evidence Permission、schema、lineage、评分职责分离并呈现 Rich 公开进度；它不会用模板替代研究思路。
