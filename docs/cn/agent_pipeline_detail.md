...
`docs/cn/README.md` 是中文导航，`docs/en/README.md` 是英文导航，它们互相链接，并共同指向本文档、根 README 和各主题参考页。中文主文档保留完整解释；英文短文档用于国际协作、命令/API 术语和快速定位。文档不应复制 workspace 运行产物、秘密、原始 trace 或模型 prompt；这些仍属于具体项目的 workspace。
