...
| T5 | 外部执行器在不发明协议的情况下能实现什么，哪些研究报告已可交给写作？ | 移交包、项目专属 Skill suite、specialization execution 记录、执行器选择、`external_executor/executor_research_report.md` | 协议、材料与执行器关卡 |
