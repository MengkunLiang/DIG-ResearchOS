...
```bash
cd /home/liangmengkun/ResearchOS
PYTHONPATH=/home/liangmengkun/ResearchOS python -m researchos.cli run --workspace ./workspace/local-test2
```
...
```bash
cd /home/liangmengkun/ResearchOS
PYTHONPATH=/home/liangmengkun/ResearchOS python -m researchos.cli resume --workspace ./workspace/local-test2
```
...
```bash
cd /home/liangmengkun/ResearchOS
PYTHONPATH=/home/liangmengkun/ResearchOS python -m researchos.cli run-task T3 --workspace ./workspace/local-test2
```
...
以 `/home/liangmengkun/ResearchOS/workspace/local-test2` 为例，典型目录包括：
...
| `T4` | `IdeationAgent` | - | 生成假设、实验计划、风险评估 | `hypotheses.md`, `exp_plan.yaml`, `risks.md` |
