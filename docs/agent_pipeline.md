...
```bash
cd ResearchOS
PYTHONPATH=. python -m researchos.cli run --workspace ./workspaces/local-test2
```
...
```bash
cd ResearchOS
PYTHONPATH=. python -m researchos.cli resume --workspace ./workspaces/local-test2
```
...
```bash
cd ResearchOS
PYTHONPATH=. python -m researchos.cli run-task T3 --workspace ./workspaces/local-test2
```
...
以 `./workspaces/local-test2` 为例，典型目录包括：
...
```bash
cd ResearchOS
researchos run-task HELLO --workspace ./workspaces/dev-smoke
```
...
researchos run-task T1 --workspace ./workspaces/local-test2
```
...
```bash
cd ResearchOS
researchos run-task T3.5 --workspace ./workspaces/local-test2
```
...
```bash
cd ResearchOS
researchos run-task T3.6 --workspace ./workspaces/local-test2
researchos run-task T3.6-GATE-SURVEY --workspace ./workspaces/local-test2
researchos run-task T3.6-PLAN --workspace ./workspaces/local-test2
researchos run-task T3.6-SEC-TAXONOMY --workspace ./workspaces/local-test2
researchos run-task T3.6-ASSEMBLE --workspace ./workspaces/local-test2
researchos run-task T3.6-REVIEW --workspace ./workspaces/local-test2
researchos run-task T3.6-COMPILE --workspace ./workspaces/local-test2
```
...
```bash
cd ResearchOS
researchos run-task T4 --workspace ./workspaces/local-test2
```
...
```bash
cd ResearchOS
researchos run-task T8-STYLE-GATE --workspace ./workspaces/local-test2
researchos run-task T8-RESOURCE --workspace ./workspaces/local-test2
researchos run-task T8-WRITE --workspace ./workspaces/local-test2
researchos run-task T8-SECTION-PLAN --workspace ./workspaces/local-test2
researchos run-task T8-SEC-METHOD --workspace ./workspaces/local-test2
researchos run-task T8-SEC-EXPERIMENTS --workspace ./workspaces/local-test2
researchos run-task T8-SEC-RELATED --workspace ./workspaces/local-test2
researchos run-task T8-SEC-ANALYSIS --workspace ./workspaces/local-test2
researchos run-task T8-SEC-INTRO --workspace ./workspaces/local-test2
researchos run-task T8-SEC-CONCLUSION --workspace ./workspaces/local-test2
researchos run-task T8-SEC-ABSTRACT --workspace ./workspaces/local-test2
researchos run-task T8-DRAFT --workspace ./workspaces/local-test2
researchos run-task T8-SELF-CHECK --workspace ./workspaces/local-test2
researchos run-task T8-REVIEW-1 --workspace ./workspaces/local-test2
researchos run-task T8-REVISE-1 --workspace ./workspaces/local-test2
```
