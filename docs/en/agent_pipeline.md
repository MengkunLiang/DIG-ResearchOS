...
| T4.5 research-plan audit and formalization | Does the selected Pre-Novelty idea remain differentiated, and can it become a coherent, falsifiable, quality-gated research package? | Phase 1 novelty/collision audit; Phase 2 shared `research_blueprint.yaml`, `claim_registry.yaml`, formal claims, Proposal and experiment plan; Phase 3 orientation-aware review/repair and formalization receipt | Novelty human review only for a non-pass audit; T4's UTD/CCF-A/Hybrid orientation is inherited without another user choice |
