...
4. T4 uses model-authored Candidate framing, mechanisms, and the smallest coherent set of one to four Draft Hypotheses and contributions inside an Evidence-Routed `P0 -> P1` workflow. Runtime code enforces Evidence Permission, schemas, lineage, scoring separation, and public Rich progress; it does not replace research ideas with templates.
